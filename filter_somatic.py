#!/usr/bin/python3
#the concept behind this script is that germline mutations will be shared between separate samples from the same individual, but somatic mutations will not
